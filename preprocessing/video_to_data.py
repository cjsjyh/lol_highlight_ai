...
def data_to_h5(filename,video_name,features,gtscore,gtsummary,n_frame_per_seg=None,n_frames=None,change_point=None,picks=None,n_steps=None,user_summary=None,video_name_original=None):
...
if __name__ == "__main__":
    vid_name = 'highlight_360.mp4'
    frame_space = 15
    full_space = 5
    features,full_features = get_googlenet_pool5(vid_name,frame_space,full_space)
    print("features_num:",str(features.shape[0]))
    print("features ")
    print(features.shape)
    print(features)
    cp = get_cp(full_features,int(full_features.shape[0]*full_space*0.07))
    change_points = cp[0]*5
    picks = [frame_space*num for num in range(0,features.shape[0])]
    ...
    change_points = numpy.vstack((change_points,change_point_end))
    print("change_points:")

...
parser.add_argument('-f', type=str, default="videos_2.txt", help="Video url list file name")
...
while True:
    ...
    if args.o == "download":
        subprocess.call(f'youtube-dl -f {args.q} -o "full_raw_2/{filename}.mp4" {video_url}', shell=True)
    print(title)
f.close()

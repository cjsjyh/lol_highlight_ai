...
python3 main2.py -t -m $MODEL -o result/result_$RESULTDIR/ > result/result_$RESULTDIR/$LOGNAME.log
python3 main2.py -m $MODEL > result/result_$RESULTDIR/evaluation.$MODEL.$LOGNAME.log

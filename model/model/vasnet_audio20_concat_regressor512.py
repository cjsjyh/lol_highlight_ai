...
class VASNet_Audio20_Concat_regressor512(nn.Module):
    ...
    def __init__(self):
        ...
        self.ka = nn.Linear(in_features=self.concat_size, out_features=1024)
    ...
    def train_wrapper(self, hps, dataset):
        ...
        audio_20 = torch.from_numpy(audio_20).unsqueeze(0)
        ...
        if hps.use_cuda:
            ...
            audio_20 = audio_20.float().cuda()
 
        return self.forward(seq,seq.shape[1],audio_20,audio_20.shape[1]) + (target,)
    ...
    def eval_wrapper(self, hps, dataset):
        ...
        return self.forward(seq, seq.shape[1],audio_20,audio_20.shape[1])

...
class VASNet_Only_Audio128_Att_1024(nn.Module):

    def __init__(self):
        super(VASNet_Only_Audio128_Att_1024, self).__init__()

        self.m = 128 # cnn features size
        self.hidden_size = 1024

        self.att = SelfAttention(input_size=self.m, output_size=self.hidden_size)
        self.ka = nn.Linear(in_features=self.hidden_size, out_features=1024)

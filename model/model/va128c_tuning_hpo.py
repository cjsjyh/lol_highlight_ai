...
class SelfAttention(nn.Module):
    ...
    def __init__(self, apperture=20, ignore_itself=False, dropout = 0.5, val_q = 0.06, input_size=1024, output_size=1024):
        ...
        self.drop50 = nn.Dropout(dropout)
...
class Audio_Resnet_Tune(nn.Module):
    ...
    def __init__(self, drop_in, drop_out, val_q, apperture):
        ...
        self.att = SelfAttention(apperture=apperture, dropout=drop_in, val_q=val_q, input_size=self.m, output_size=self.m)
        ...
        self.sig = nn.Sigmoid()
        self.relu = nn.ReLU()
        self.drop50 = nn.Dropout(drop_out)
